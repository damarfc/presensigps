...
<div class="section" id="user-section">
    <div id="user-detail">
        <div class="avatar">
            @if (!empty(Auth::guard('perangkat_desa')->user()->foto))
            @php
                $path = Storage::url('uploads/perangkatdesa/'.Auth::guard('perangkat_desa')->user()->foto)
            @endphp
        ...
        <div id="user-info">
            <h2 id="user-name">{{ Auth::guard('perangkat_desa')->user()->nama_lengkap }}</h2>
            <span id="user-role">{{ Auth::guard('perangkat_desa')->user()->jabatan }}</span>
        </div>
    </div>
</div>
